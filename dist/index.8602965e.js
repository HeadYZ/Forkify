...
///////////////////////////////////////
var renderSpinner = function(parentEl) {
...
var showRecipe = function() {
    var _ref = (0, _asyncToGenerator._)(function() {
        var res, data, recipe, markup, err;
        return (0, _tsGenerator._)(this, function(_state) {
            switch(_state.label){
                case 0:
                    _state.trys.push([
                    ...
                    return [
                        4,
                        fetch("https://forkify-api.herokuapp.com/api/v2/recipes/5ed6604591c37cdc054bca57")
                    ];
                case 1:
                    res = _state.sent();
                    return [
...
},{"@swc/helpers/_/_async_to_generator":"5Aj3n","@swc/helpers/_/_ts_generator":"6WJcv","../img/icons.svg":"3FuW9","@parcel/transformer-js/src/esmodule-helpers.js":"5ITdS"}],"3FuW9":[function(require,module,exports) {
